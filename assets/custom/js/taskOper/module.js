        ...
        if (response.ok) {
            ...
            for (let index = 0; index < ingredients.length; index++) {
              ...
              if (!result) {
                ...
                document.querySelector('.title-modal-ingredient').textContent = element.ingredient.name
                document.querySelector('.current-weight').textContent = 0
                document.querySelector('.objective-weight').textContent = `${element.cuantity} ${element.controlUnit}`
                document.querySelector('.title-scale').textContent = element.cuantity > 15000 ? `Bascula de Piso` : `Bascula de Mesa`;
                break;
              }
            }
